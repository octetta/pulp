...
- **C API Opcode**: `SKODE_OP_AMP` (Value: 3)
- **Arguments**: `1` to `1`
...
- **C API Opcode**: `SKODE_OP_AMP_BEND` (Value: 54)
- **Arguments**: `1` to `1`
...
- **C API Opcode**: `SKODE_OP_AMP_BEND_PARAM` (Value: 55)
- **Arguments**: `1` to `2`
...
- **C API Opcode**: `SKODE_OP_FREQ` (Value: 4)
- **Arguments**: `1` to `1`
- **Summary**: freq hz
...
- **C API Opcode**: `SKODE_OP_FREQ_BEND` (Value: 52)
- **Arguments**: `1` to `1`
...
- **C API Opcode**: `SKODE_OP_FREQ_BEND_PARAM` (Value: 53)
- **Arguments**: `1` to `2`
...
- **C API Opcode**: `SKODE_OP_MUTE` (Value: 26)
- **Arguments**: `1` to `1`
...
- **C API Opcode**: `SKODE_OP_MIDI_NOTE` (Value: 5)
- **Arguments**: `1` to `2`
...
- **C API Opcode**: `SKODE_OP_PAN` (Value: 6)
- **Arguments**: `1` to `1`
- **Summary**: pan value
...
- **C API Opcode**: `SKODE_OP_VOICE` (Value: 2)
- **Arguments**: `1` to `1`
