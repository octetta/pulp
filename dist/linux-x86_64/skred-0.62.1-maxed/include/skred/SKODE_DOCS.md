...
- **C API Opcode**: `SKODE_OP_STREAM_COPY`
- **Arguments**: `2` to `2`
...
- **C API Opcode**: `SKODE_OP_STREAM_MODE`
- **Arguments**: `2` to `2`
...
- **C API Opcode**: `SKODE_OP_STREAM_POS`
- **Arguments**: `2` to `2`
...
- **C API Opcode**: `SKODE_OP_PATTERN_STATE`
- **Arguments**: `2` to `2`
...
- **C API Opcode**: `SKODE_OP_PATTERN_LOOP`
- **Arguments**: `3` to `3`
