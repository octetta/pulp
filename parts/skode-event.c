...
static int skode_compile_callback(ands_t *s, int info) {
  ...
  switch (atom) {
    ...
    case SKODE_ATOM('V', 'L', '-', '-'):
      ...
      break;
    case SKODE_ATOM('p', 'n', '-', '-'):
      opcode = SKODE_OP_POLY_NOTE; min_argc = 4; max_argc = 5;
      break;
    case SKODE_ATOM('p', 'r', '-', '-'):
      opcode = SKODE_OP_POLY_RELEASE; min_argc = 2; max_argc = 3;
      break;
    case SKODE_ATOM('p', 'b', '-', '-'):
...
int skode_is_legacy_realtime_opcode(uint32_t atom) {
  switch (atom) {
    ...
    case SKODE_ATOM('/', 'f', '-', '-'):
    case SKODE_ATOM('/', 'f', 'f', '-'):
    case SKODE_ATOM('/', 'c', 'e', 'r'):
    case SKODE_ATOM('/', 'c', 'e', '?'):
    case SKODE_ATOM('/', 't', 'h', '?'):
    case SKODE_ATOM('/', 't', 'h', '!'):
    case SKODE_ATOM('/', 'c', 'e', '!'):
    case SKODE_ATOM('/', 'c', 'e', 'b'):
    case SKODE_ATOM('/', 'c', 'e', 'x'):
    case SKODE_ATOM('<', 's', '-', '-'):
    case SKODE_ATOM('s', '>', '-', '-'):
    case SKODE_ATOM('s', '%', '-', '-'):
    case SKODE_ATOM('<', 'e', '-', '-'):
