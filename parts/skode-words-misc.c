...
static skode_word_t word_gn = { WID("gn"), .execute = word_exec_pn, .safety = WORD_IMMEDIATE_ONLY };
static skode_word_t word_pr = { WID("pr"), .execute = word_exec_pr, .safety = WORD_IMMEDIATE_ONLY };
static skode_word_t word_gr = { WID("gr"), .execute = word_exec_pr, .safety = WORD_IMMEDIATE_ONLY };
...
static skode_word_t word__qws = { WID("?ws"), .execute = word_exec_WS, .safety = WORD_IMMEDIATE_ONLY , .category = "wave" };
...
void skode_register_words_misc(skode_vocab_t *vocab) {
  ...
  skode_dict_register(vocab, &word_gn);
  skode_dict_register(vocab, &word_pr);
  skode_dict_register(vocab, &word_gr);
  ...
  skode_dict_register(vocab, &word__qws);
