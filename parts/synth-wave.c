...
void wave_table_init(int flag) {
  ...
  for (int w = WAVE_TABLE_SINE; w <= WAVE_TABLE_DRUM_18; w++) {
    ...
    switch (w) {
      ...
      case WAVE_TABLE_DRUM_01: name = "drum-01"; break;
      case WAVE_TABLE_DRUM_02: name = "drum-02"; break;
      case WAVE_TABLE_DRUM_03: name = "drum-03"; break;
      case WAVE_TABLE_DRUM_04: name = "drum-04"; break;
      case WAVE_TABLE_DRUM_05: name = "drum-05"; break;
      case WAVE_TABLE_DRUM_06: name = "drum-06"; break;
      case WAVE_TABLE_DRUM_07: name = "drum-07"; break;
      case WAVE_TABLE_DRUM_08: name = "drum-08"; break;
      case WAVE_TABLE_DRUM_09: name = "drum-09"; break;
      case WAVE_TABLE_DRUM_10: name = "drum-10"; break;
      case WAVE_TABLE_DRUM_11: name = "drum-11"; break;
      case WAVE_TABLE_DRUM_12: name = "drum-12"; break;
      case WAVE_TABLE_DRUM_13: name = "drum-13"; break;
      case WAVE_TABLE_DRUM_14: name = "drum-14"; break;
      case WAVE_TABLE_DRUM_15: name = "drum-15"; break;
      case WAVE_TABLE_DRUM_16: name = "drum-16"; break;
      case WAVE_TABLE_DRUM_17: name = "drum-17"; break;
      case WAVE_TABLE_DRUM_18: name = "drum-18"; break;
      default: name = "?"; break;
    }
