...
1. Download an official amalgamated release zip from the miniz repository.
2. Extract `miniz.h` and `miniz.c` into your build environment.
3. Compile both `.c` files alongside your engine source. 
